...
function OpenSaveableMenu(submitCb, cancelCb, restrict)
	...
	OpenMenu(function(data, menu)
		...
		TriggerEvent('skinchanger:getSkin', function(skin)
			...
			TriggerEvent("esx:showAdvancedStreamedNotification", 'LaFive', 'Information ⚠️', 'Si vous avez raté la création de votre personnage, faites /register dans le f8 pour le refaire.', 'CHAR_FLOYD', 'lafive', 2)
		...
		if FirstSpawn then
			...
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
				...
				if skin == nil then
					...
					TriggerEvent('instance:registerType', 'property', {property = random, enter = 0, exit = 0})
					TriggerEvent('instance:create', 'property', {property = random, owner = GetPlayerPed(-1)})
					FreezeEntityPosition(GetPlayerPed(-1), true)
					TriggerEvent('skinchanger:loadSkin', {sex = 0})
					TriggerEvent('vCreator:OpenMenu')
